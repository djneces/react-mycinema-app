...
export const FETCH_OCCUPANCY_FAIL = 'FETCH_OCCUPANCY_FAIL';
export const CLEAR_OCCUPANCY = 'CLEAR_OCCUPANCY';
export const SAVE_OCCUPANCY_SUCCESS = ' SAVE_OCCUPANCY_SUCCESS';
export const SAVE_OCCUPANCY_FAIL = ' SAVE_OCCUPANCY_FAIL';
